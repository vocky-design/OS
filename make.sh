...
gcc -m32  -fno-builtin -fno-stack-protector -c -I lib/kernel/ -o build/timer.o kernel/timer.c
...
build/main.o build/init.o build/interrupt.o build/kernel.o build/print.o build/timer.o
#加载
